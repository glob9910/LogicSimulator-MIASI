...
public class CircuitGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "LPARENTH", "RPARENTH", 
			"LCPARENTH", "RCPARENTH", "NOT", "AND", "OR", "XOR", "NAND", "NOR", "XNOR", 
			"EQ", "SEMI", "BOOL", "ID", "WS"
		};
	}
	...
	public CircuitGrammarLexer(CharStream input) {
		super(input);
